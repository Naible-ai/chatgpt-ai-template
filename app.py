...
UI_TITLE = os.environ.get("UI_TITLE") or "SIQ"
UI_LOGO = os.environ.get("UI_LOGO")
UI_CHAT_LOGO = os.environ.get("UI_CHAT_LOGO")
UI_CHAT_TITLE = os.environ.get("UI_CHAT_TITLE") or "Start chatting with StandardsIQ"
UI_CHAT_DESCRIPTION = os.environ.get("UI_CHAT_DESCRIPTION") or "This AI Agent is configured to answer your about Pearson's policies and Standards"
